...
<div class="titulo">
    ...
    <div class="busca">
        <form name="form1" method="POST" action="">
            ...
            <div class="botao">
                <a href="principal.html"> <span class="material-icons">
arrow_back
</span> </a>
               </div>
        </form>
    ...
    while ($obj = mysql_fetch_array($result))
    {
        ...
        <div class=\"busca\">
            <form name=\"formulario\" method=\"post\" action=\"excluir.php\">
                    Codigo: <input name=\"cli_cod\" type=\"text\" value=\"$cod\"><br>
                    Nome: <input name=\"cli_nome\" type=\"text\" value=\"$nome\"><br>
                    Telefone: <input name=\"cli_fone\" type=\"text\" value=\"$fone\"><br>
                    CPF: <input name=\"cli_cpf\" type=\"text\" value=\"$cpf\"><br>
                    Data: <input name=\"cli_data\" type=\"text\" value=\"$data\"><br>
            <div class=\"labelsBusca\">
